  ...
  return (
    <div style={{ fontFamily: "var(--font-geist, system-ui, sans-serif)", background: "#fff", minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "64px 32px 96px" }}>
        ...
        <Section>
          Si detectas un uso del Servicio que infrinja esta PUA, te pedimos que lo reportes a <a href="mailto:privacy@plainsocial.app" style={{ color: "#111" }}>privacy@plainsocial.app</a>. Investigaremos todas las notificaciones con diligencia y tomaremos las medidas adecuadas.
        </Section>
        ...
        <H2>9. Contacto</H2>
        <Section>
          Para consultas sobre esta Política o para reportar infracciones: <a href="mailto:privacy@plainsocial.app" style={{ color: "#111" }}>privacy@plainsocial.app</a> · Addicional Marketing, S.L., Sabadell, Barcelona, España.
        </Section>
      </div>
