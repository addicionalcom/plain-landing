  ...
  return (
    <div style={{ fontFamily: "var(--font-geist, system-ui, sans-serif)", background: "#fff", minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "64px 32px 96px" }}>
        ...
        <Section>
          Para usar el Servicio debes tener al menos 18 años y capacidad legal para suscribir contratos. Al crear una cuenta proporcionas información veraz y actualizada. Eres responsable de mantener la confidencialidad de tus credenciales y de todas las acciones realizadas bajo tu cuenta. Notifícanos de inmediato ante cualquier acceso no autorizado a <a href="mailto:privacy@plainsocial.app" style={{ color: "#111" }}>privacy@plainsocial.app</a>.
        </Section>
        ...
        <H2>13. Contacto</H2>
        <Section>
          Para cualquier consulta sobre estos Términos, escríbenos a <a href="mailto:privacy@plainsocial.app" style={{ color: "#111" }}>privacy@plainsocial.app</a> o a <strong>Addicional Marketing, S.L., Sabadell, Barcelona, España</strong>.
        </Section>
      </div>
