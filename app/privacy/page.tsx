  ...
  return (
    <div style={{ fontFamily: "var(--font-geist, system-ui, sans-serif)", background: "#fff", minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "64px 32px 96px" }}>
        ...
        <Section>
          <strong>Addicional Marketing, S.L.</strong> («Plain», «nosotros», «nos»), con domicilio en Sabadell, Barcelona, España, y contacto de privacidad <a href="mailto:dpo@addicional.com" style={{ color: "#111" }}>dpo@addicional.com</a>, es el responsable del tratamiento de los datos personales recogidos a través de <strong>plainsocial.app</strong> y de la plataforma <strong>Plain Social</strong> («el Servicio»).
        </Section>
        <Section>
          Esta Política explica qué datos recogemos, cómo los usamos, con quién los compartimos, cuánto tiempo los conservamos y qué derechos tienes. Si tienes preguntas, escribe a <a href="mailto:dpo@addicional.com" style={{ color: "#111" }}>dpo@addicional.com</a>.
        </Section>
        ...
        <Section>
          ...
          <a href="mailto:dpo@addicional.com" style={{ color: "#111" }}>dpo@addicional.com</a><br />
